...
const Home = () => {
  return (
    <section className="min-h-[calc(100vh-72px)] bg-gradient-to-b from-[#0b0f13] to-[#1f242b] text-white flex flex-col justify-center items-center px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
      ...
      <div className="w-full flex flex-col items-center px-4">
        ...
        <div className="bg-[#262c33] rounded-2xl shadow-lg border border-white/10 w-full max-w-5xl">
          <CompetenceCarousel />
        </div>
      </div>
    </section>
